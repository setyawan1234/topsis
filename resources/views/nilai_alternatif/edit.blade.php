                ...
                <div class="modal-body">
                    ...
                    @foreach ($kriteria as $krit)
                        <div class="form-group my-3">
                            ...
                            <select name="value{{ $krit->kode_kriteria }}" id="value" class="custom-select" required="required">
                                <option value="" selected disabled hidden></option>
                                @foreach ($krit->subkriteria as $subkrit)
                                    <option value="{{ $subkrit->bobot_subkriteria }}" @if ($item->value == $subkrit->nilai_subkriteria ) selected @endif>
